...
public interface JsonHandler {
    ...
    /**
     * Serialize the given {@link Row} as a JSON string. Supports all data types supported by Kernel
     * except the MapType with non-String types as keys.
     *
     * @param row
     * @return
     */
    String serializeAsJson(Row row);
