...
public class TransactionBuilderImpl implements TransactionBuilder {
    ...
    @Override
    public TransactionBuilder withReadOfTable(
            TableClient tableClient,
            long readVersion,
     ...
     */
    private void validate(TableClient tableClient, Snapshot snapshot) {
    ...
    private class InitialSnapshot extends SnapshotImpl {
        InitialSnapshot(
                ...
                Metadata metadata,
                Protocol protocol) {
            super(dataPath, -1 /* version */, logReplay, protocol, metadata);
        }
    }
