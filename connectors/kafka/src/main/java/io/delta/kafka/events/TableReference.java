...
/** Element representing a table using path */
public class TableReference implements IndexedRecord {
  private String path;
  private final Schema avroSchema;

  static final int PATH = 10_600;

  public static final StructType DELTA_SCHEMA = new StructType().add("path", StringType.STRING);

  private static final Schema AVRO_SCHEMA = AvroUtil.convert(DELTA_SCHEMA, TableReference.class);
  ...
  public TableReference(String path) {
